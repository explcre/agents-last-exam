...
data/              generated, committed
  ...
  tapes.json         every roll tape, one map
...
4. **The corpus was 36 MB.** Every tape was 65,536 rolls while a 20-update battle
   ...
   byte-identical transcripts across 144 scenarios, then consolidated 278 tape
   files into one map to avoid 278 staging round trips. Now 1.3 MB.
